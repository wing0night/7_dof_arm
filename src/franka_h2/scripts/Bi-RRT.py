...
import time
from franka_h2.scripts.fk import cal_fk
from franka_h2.scripts.ik_geo import franka_IK_EE    
...
class BiRRTPlanner:
    ...
    def move_to_goal(self, goal_positions, duration=10.0):
        ...
        for i in range(len(total_points)):
            ...
            point.positions = total_points[i]
            point.velocities = total_velocities[i]
...
if __name__ == '__main__':
    try:
        ...
        planner.move_to_goal(goal_positions, duration=10.0)
